...
text = 'A cat and a dog playing, at the left side of the image there is a dog, there are a cat hunting on top of dog.\
    ...
    Random text, asd qqq. \
    on the top right there is a cat.\
    In the buttom left side are a bed and a bedside table. \
    There is a monkey in the top of a green tree with apples at the top of the image.\
...
text = 'A cat and a dog playing at the left side of the image there is a dog.'
